...
Are all effective sizes above 400? `r all(effSizes > 400)`
...
Worked on the project idea, model building and validations.

## Jerome Finn

Worked on the project evaluation, presentation and validations.

## Nilesh Malpekar

Worked on the data preparations, restructuring project report code and validations.
