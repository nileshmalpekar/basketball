...
data_meta <- data.frame( 
  Datasource = c("Seasons_Stats", "Season_Stats, Players", "Players", 
      rep("Seasons_Stats", 8)),
  Field_Name = c("Year", "Player", "Height", "Pos", "Tm", "Age", "MP", 
      "PER", "FG", "FGA", "BLK"),
  Description = c("NBA year", "Player name", "Height in cm", 
      "Player position", "NBA team name", "Player age", "Minutes played", 
      "Player Efficiency Rating", "Field Goals", "Field Goals Attempted", "Blocks")
  )
kable(data_meta)
```
